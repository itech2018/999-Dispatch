...
$facs_ct = mysql_num_rows($result_fac);
...
$tab_1 .= "<TR CLASS='even'><TD CLASS='td_label text' ALIGN='right'>Status:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left'>" . $the_status . " </TD></TR>";
$tab_1 .= "<TR CLASS='even'><TD CLASS='td_label text' ALIGN='right'>As of:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left'>" . format_date(strtotime($row_fac['updated'])) . "</TD></TR>";
$tab_1 .= "<TR CLASS='odd'><TD CLASS='td_label text' ALIGN='right'>Contact:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left'>" . addslashes($row_fac['contact_name']). " Via: " . addslashes($row_fac['contact_email']) . "</TD></TR>";
if(!(isempty(trim($row_fac['security_contact']))))	{$line_ctr++; $tab_1 .= "<TR CLASS='odd'><TD CLASS='td_label text' ALIGN='right' STYLE= 'width:50%'>Security contact:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left' STYLE= 'width:50%'>" . addslashes($row_fac['security_contact']) . " </TD></TR>";}
if(!(isempty(trim($row_fac['security_email']))))  	{$line_ctr++; $tab_1 .= "<TR CLASS='even'><TD CLASS='td_label text' ALIGN='right'>Security email:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left'>" . addslashes($row_fac['security_email']) . " </TD></TR>";}
if(!(isempty(trim($row_fac['security_phone']))))  	{$line_ctr++; $tab_1 .= "<TR CLASS='odd'><TD CLASS='td_label text' ALIGN='right'>Security phone:&nbsp;</TD><TD CLASS='td_data_wrap text' ALIGN='left'>" . addslashes($row_fac['security_phone']) . " </TD></TR>";}
