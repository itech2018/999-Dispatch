...
.but_container{color: #FFFFFF; border: 1px solid black; text-align: center; position: fixed; top: 5px; left: 1px; z-index: 999; padding-top: 10px; padding-bottom: 10px; background-color: rgb(0%,0%,0%); background-color: rgba(0%, 0%, 0%, 0.5); width: 98%}
...
.text_valign_top {vertical-align: text-top;}
