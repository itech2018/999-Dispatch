...
function get_rescue_type($id, $edit=false) {
	global $rescue_types;
	if($edit) {	//	edit - return Select Control with selected item
		$return = "<SELECT ID='rescue_type' TABINDEX=15 NAME='frm_rescue_type'>";	
		$return .= "<OPTION VALUE=0 SELECTED>Select One</OPTION>";
		foreach($rescue_types as $key=>$val) {
			$sel = ($key == $id) ? "SELECTED" : "";
			$return .= "<OPTION VALUE=" . $key . " " . $sel . ">" . $val . "</OPTION>";
			}
		$return .= "</SELECT>";
		} else { // View, return text only
		$return = $rescue_types[$id];
		}
	return $return;
	}
...
?>
	...
	<html>
	<HEAD>
	<TITLE>Tickets - Service User Request</TITLE>
...
<?php
	...
	$can_edit = ((is_service_user() && !$only_view) || ((is_administrator() || is_super()) && $row['requester'] == 99999)) ? TRUE : FALSE;
...
<?php	
	...
	$theRequester = ($row['requester'] == 99999) ? $row['contact'] : get_user_name($row['requester']);
?>
	</SCRIPT>
	...
	<DIV id='view' style='position: absolute; width: 95%; text-align: center; margin: 10px;'>
		...
		<DIV id='leftcol' style='position: fixed; left: 2%; top: 8%; width: 96%; height: 80%;'>
			<DIV id='left_scroller' style='position: relative; top: 0px; left: 0px; height: 90%; overflow-y: auto; overflow-x: hidden; border: 1px outset #000000;'>
				<TABLE style='width: 100%;'>
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'>Requested By</TD><TD class='td_data text' style='text-align: left;'><?php print $theRequester;?></TD>
					</TR>
					<TR class='even'>	
...
?>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Imminent Danger');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['danger'];?></TD>
						</TR>
						<TR class='odd'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Water');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['water'];?></TD>
						</TR>
						<TR class='even'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Power');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['power'];?></TD>
						</TR>
						<TR class='odd'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Food');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['food'];?></TD>
						</TR>
						<TR class='even'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Health Conditions');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['health'];?></TD>
						</TR>
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Adults');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['adults'];?></TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Adults');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['adults'];?></TD>
						</TR>
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Children');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['children'];?></TD>
						</TR>								
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Elderly');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['elderly'];?></TD>
						</TR>
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Livestock');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['livestock'];?></TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('About Livestock');?></TD><TD class='td_data text' style='text-align: left;'><?php print $row['livestock_about'];?></TD>
						</TR>
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Rescue Type');?></TD><TD class='td_data text' style='text-align: left;'><?php print get_rescue_type($row['rescue_type'], FALSE);?></TD>
						</TR>
<?php
						}
?>
			...
			<BR />
			<BR />
			<DIV id='buttons' style='width: 100%; height: auto; display: block; line-height: 30px;'>
<?php
				if($can_edit) {
?>
...
?>
	...
	<DIV id='edit' style='position: absolute; width: 95%; text-align: center; margin: 10px;'>
		...
		<DIV id='edit_leftcol' style='position: fixed; left: 2%; top: 8%; width: 96%; height: 80%;'>
			<DIV id='edit_left_scroller' style='position: relative; top: 0px; left: 0px; height: 90%; overflow-y: auto; overflow-x: hidden; border: 1px outset #000000;'>
				...
				<TABLE style='width: 100%;'>
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'>Requested By</TD>
						<TD class='td_data text' style='text-align: left;'><?php print $theRequester;?></TD>
					</TR>
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'>Request Date and Time</TD>
						<TD class='td_data text' style='text-align: left;'><?php print generate_dateonly_dropdown('request_date',strtotime($row['request_date']),FALSE);?></TD>
					</TR>	
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Status');?></TD>
						<TD class='td_data text' style='text-align: left;'><?php print $status_sel;?></TD>
					</TR>					
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Patient');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_patient' TYPE='TEXT' SIZE='24' MAXLENGTH='64' VALUE="<?php print $row['the_name'];?>">
						</TD>
					</TR>	
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Street');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_street' TYPE='TEXT' SIZE='24' MAXLENGTH='128' VALUE="<?php print $row['street'];?>">
						</TD>
					</TR>	
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('City');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_city' TYPE='TEXT' SIZE='24' MAXLENGTH='64' VALUE="<?php print $row['city'];?>">
						</TD>
					</TR>
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Postcode');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_postcode' TYPE='TEXT' SIZE='24' MAXLENGTH='64' VALUE="<?php print $row['postcode'];?>">
						</TD>
					</TR>						
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('State');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_state' TYPE='TEXT' SIZE='4' MAXLENGTH='4' VALUE="<?php print $row['state'];?>">
						</TD>
					</TR>	
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Destination Address');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_toaddress' TYPE='TEXT' SIZE='24' MAXLENGTH='128' VALUE="<?php print $row['to_address'];?>">
						</TD>
					</TR>	
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Pickup Time');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_pickup' TYPE='TEXT' SIZE='24' MAXLENGTH='128' VALUE="<?php print $row['pickup'];?>">
						</TD>
					</TR>	
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Arrival Time');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_arrival' TYPE='TEXT' SIZE='24' MAXLENGTH='128' VALUE="<?php print $row['arrival'];?>">
						</TD>
					</TR>	
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Phone');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_phone' TYPE='TEXT' SIZE='16' MAXLENGTH='16' VALUE="<?php print $row['phone'];?>">
						</TD>
					</TR>
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Originating Facility');?></TD>
						<TD class='td_data text' style='text-align: left;'><?php print $orig_fac_menu;?></TD>
					</TR>					
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Receiving Facility');?></TD>
						<TD class='td_data text' style='text-align: left;'><?php print $rec_fac_menu;?></TD>
					</TR>
					<TR class='odd'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Scope');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<INPUT NAME='frm_scope' TYPE='TEXT' SIZE='24' MAXLENGTH='64' VALUE="<?php print $row['scope'];?>">
						</TD>
					</TR>	
					<TR class='even'>	
						<TD class='td_label text' style='text-align: left;'><?php print get_text('Description');?></TD>
						<TD class='td_data text' style='text-align: left;'>
							<TEXTAREA NAME="frm_description" COLS="45" ROWS="10" WRAP="virtual"><?php print $row['description'];?></TEXTAREA>
						</TD>
					</TR>
<?php
					if($public) {
?>
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Imminent Danger');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='danger' name='frm_danger'>
<?php
									$sel_yes = ($row['danger'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['danger'] == "No") ? "SELECTED" : "";									
?>
						...
						<TR class='even'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Water');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='water' name='frm_water'>
<?php
									$sel_yes = ($row['water'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['water'] == "No") ? "SELECTED" : "";									
?>
									<OPTION VALUE='No' <?php print $sel_no;?> >No</OPTION>
									<OPTION VALUE='Yes' <?php print $sel_yes;?> >Yes</OPTION>
								</SELECT>
						...
						<TR class='odd'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Power');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='power' name='frm_power'>
<?php
									$sel_yes = ($row['power'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['power'] == "No") ? "SELECTED" : "";									
?>
									<OPTION VALUE='No' <?php print $sel_no;?> >No</OPTION>
									<OPTION VALUE='Yes' <?php print $sel_yes;?> >Yes</OPTION>
								</SELECT>
						...
						<TR class='even'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Got Food');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='food' name='frm_food'>
<?php
									$sel_yes = ($row['food'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['food'] == "No") ? "SELECTED" : "";									
?>
									<OPTION VALUE='No' <?php print $sel_no;?> >No</OPTION>
									<OPTION VALUE='Yes' <?php print $sel_yes;?> >Yes</OPTION>
								</SELECT>
						...
						<TR class='odd'>
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Health Conditions');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='health' name='frm_health'>
<?php
									$sel_yes = ($row['health'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['health'] == "No") ? "SELECTED" : "";
									$sel_unk = ($row['health'] == "Unknown") ? "SELECTED" : "";										
?>
									<OPTION VALUE='No' <?php print $sel_no;?> >No</OPTION>
									<OPTION VALUE='Yes' <?php print $sel_yes;?> >Yes</OPTION>
									<OPTION VALUE='Unknown' <?php print $sel_unk;?> >Yes</OPTION>
								</SELECT>
							</TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Adults');?></TD>
							<TD class='td_data text' style='text-align: left;'>
						...
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Adults');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<INPUT NAME='frm_adults' TYPE='TEXT' SIZE='2' MAXLENGTH='2' VALUE="<?php print $row['adults'];?>">
							</TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Children');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<INPUT NAME='frm_children' TYPE='TEXT' SIZE='2' MAXLENGTH='2' VALUE="<?php print $row['children'];?>">
							</TD>
						</TR>								
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Number of Elderly');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<INPUT NAME='frm_elderly' TYPE='TEXT' SIZE='2' MAXLENGTH='2' VALUE="<?php print $row['elderly'];?>">
							</TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Livestock');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<SELECT id='livestock' name='frm_livestock'>
<?php
									$sel_yes = ($row['livestock'] == "Yes") ? "SELECTED" : "";
									$sel_no = ($row['livestock'] == "No") ? "SELECTED" : "";									
?>
									<OPTION VALUE='No' <?php print $sel_no;?> >No</OPTION>
									<OPTION VALUE='Yes' <?php print $sel_yes;?> >Yes</OPTION>
								</SELECT>
						...
						<TR class='odd'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('About Livestock');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<TEXTAREA NAME="frm_livestock_about" COLS="45" ROWS="10" WRAP="virtual"><?php print $row['livestock_about'];?></TEXTAREA>
							</TD>
						</TR>
						<TR class='even'>	
							<TD class='td_label text' style='text-align: left;'><?php print get_text('Rescue Type');?></TD>
							<TD class='td_data text' style='text-align: left;'>
								<?php print get_rescue_type($row['rescue_type'], TRUE);?>
							</TD>
						</TR>
<?php
						}
