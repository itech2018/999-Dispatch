...
if($result) {
	$ret_arr[0] = 100;
	do_log($GLOBALS['LOG_DECLINE_REQUEST'], $by);	
		$to_str1 = "";
		$smsg_to_str1 = "";
		$subject_str1 = "";
		$text_str1 = "";	
	...
	if ($the_email != "") {				// requester address?
		...
		$smsg_to_str1 = "";
		if($row['requester'] == 99999) {
			$subject_str1 = "Your request has unfortunately been Declined.";
			$text_str1 = "Your Request has unfortunately had to be declined.\r\n"; 
