...
function showPosition(position) {
	...
	theAltitude = (position.coords.altitude) ? position.coords.altitude : 0;
	theHeading = (position.coords.heading) ? position.coords.heading : 0;
	theSpeed = (position.coords.speed) ? position.coords.speed : 0;
...
function get_message(message_id) {
	...
	function message_cb(req) {
		...
		setTimeout(function() {$('reply_but').style.display = "inline"; msg_subject = the_message[2]; msg_text = the_message[3];},1000);	
