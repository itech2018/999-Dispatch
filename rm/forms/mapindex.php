...
<style type="text/css">
	*, html { margin:0; padding:0 }
	...
	div#app_title { width: 100%; z-index: 6; color: #000000; background-color: #0316FE; font-size: 1em; font-weight: bold; display: inline-block;}
	...
	.screen { z-index: 5; position: relative; left: 5%; top: 70px; width: 78%; height: 50%; background: transparent;}
	.chat_screen { z-index: 5; position: relative; left: 5%; top: 70px; width: 78%; height: 50%; background: transparent;}	
	.screen_but_hover { display:-moz-inline-block; display:-moz-inline-box; display:inline-block; margin-left: 4px;  font: normal 12px Arial, Helvetica, sans-serif; color:#FF0000; 
				border-width: 5px; border-STYLE: inset; border-color: #FFFFFF; padding: 4px 0.5em;text-decoration: none;float: none; 
	...
	.screen_but_hover_r { display:-moz-inline-block; display:-moz-inline-box; display:inline-block;  display:-moz-inline-block; display:-moz-inline-box; display:inline-block; 
				float: none; font: normal 12px Arial, Helvetica, sans-serif; color:#FF3366; border-width: 5px; border-STYLE: inset; border-color: #FFFFFF;
...
var do_chat = false;
var theIcon;
var user_id = parseInt("<?php print $the_user;?>");
...
function get_help(responder_id, respondername) {
	if (typeof broadcast != 'undefined') {
		broadcast('Responder ' + responder + ' needs assistance', 99);
		} else {
		var randomnumber=Math.floor(Math.random()*99999999);
		setTimeout(function() {
			var url ='./ajax/emer_message.php?responderid=' + responder_id + '&version=' + randomnumber;
			sendRequest (url,help_cb, "");	
			},1000);
		}
	}
	
function help_cb(req) {
	var help_response=JSON.decode(req.responseText);
	if(help_response[0] == 100) {
...
function get_tickets() {
	...
	function tickets_cb(req) {
		...
		$('ticket_list').innerHTML = "Loading Incident List............";
		setTimeout(function() {$('ticket_list').innerHTML = the_tickets;},1000);
		}
	}	
	
function get_ticket_markers() {
	if(user_id == 0) return;
	randomnumber=Math.floor(Math.random()*99999999);
	var tkticonUrl;	
	var tkticon;
	...
	function ticketMarkers_cb(req) {
		...
		if(the_tickets[0][0] == 0) {return true;}
...
function get_ticket(ticket_id) {
	...
	function ticket_cb(req) {
		...
		$('fenr_but').innerHTML = "Fac En-Route<BR />" + the_ticket[4]; 
		...
		$('ticket_detail').innerHTML = "Loading Incident Details............";
...
function close_ticket_detail() {
	...
	$('fenr_but').innerHTML = "Fac En-Route"; $('fenr_but').style.backgroundColor = '#EFEFEF'; $('fenr_but').style.color = '#000000'; $('fenr_but').setAttribute( "onClick", "do_sub(\"frm_u2fenr\",\"fenr_but\");" ); $('fenr_but').setAttribute( "onMouseover", "do_hover(this.id)" );	$('fenr_but').setAttribute( "onMouseout", "do_plain(this.id)" );
...
function alert_location() {
	do_geolocate(theLatLng, the_lat, the_lng);
...
function get_geo() {	//	Start up the geo location
	...
	if(user_id != 0) {	//	if not logged in, only get position updates - no messages, chat or tickets
		...
		get_ticket_markers();	// get ticket markers first time
...
function secondary_repeats() {
	...
	get_ticket_markers();	// get new ticket markers
...
function send_message() {
	...
	function send_msg_cb(req) {
		...
		$('reply_message_alert').style.display = "block";
		if(the_response[0] == 100) {
			$('message_detail').style.display = "block";
			$('message_reply').style.display = "none";
			$('reply_message_alert').innerHTML = "Reply Sent";
			setTimeout(function() {$('reply_message_alert').style.display = "none";},4000);
			} else {
			$('message_detail').style.display = "block";
			$('message_reply').style.display = "none";
			$('reply_message_alert').innerHTML = "Reply FAILED";
			setTimeout(function() {$('reply_message_alert').style.display = "none";},4000);
			}
		}	
	}
...
?>
			...
			<SPAN id='help_but' class='plain text' style='display: inline-block; z-index: 10; width: 40px; height: 40px; vertical-align: middle;' onMouseOver="do_hover(this.id);" onMouseOut="do_plain(this.id);" onClick = "get_help(<?php print $the_responder;?>,'<?php print $respondername;?>');"><IMG SRC='./images/help.png' ALT='Help' BORDER=0 /></SPAN>
			<BR /><BR />
...
?>
		...
		<DIV id="buttons2" style='position:absolute; left:-300px; top: 130px; z-index: 10; text-align: center;'>				
			...
			<span id="fenr_but" class='plain' style="display: block; z-index: 10;" onMouseOver="do_hover(this.id);" onMouseOut="do_plain(this.id);" onClick = 'do_sub("frm_u2fenr","fenr_but");'>Fac En-Route</span>	
			<span id="farr_but" class='plain' style="display: block; z-index: 10;" onMouseOver="do_hover(this.id);" onMouseOut="do_plain(this.id);" onClick = 'do_sub("frm_u2farr","farr_butt");'>Fac Arrived</span>
...
?>		
		...
		<DIV id='screen3' class='screen' style='display: none;'>
			...
			<DIV id="ticket_detail_wrapper" style='z-index: 5; text-align: left; display: none; background-color: #EFEFEF;'>
				...
				<DIV id="tkt_message_reply" class='detail_page' style='display: none;'>
					<DIV class='heading' style='width: 100%; height: 45px; text-align: center; color: #000000; background-color: #707070;'>MESSAGE DETAIL<span id='message_alert' style='height: 15px; float: left; color: red; font-weight: bold; display: inline-block; z-index: 99;'></span>		
		...
		<DIV id='screen4' class='screen' style='display: none;'>
			...
			<DIV id="message_reply" class='detail_page' style='display: none;'>
				<DIV class='heading' style='display: block; width: 100%; height: 45px; text-align: center; color: #000000; background-color: #707070;'>MESSAGE DETAIL<span id='message_alert' style='height: 15px; float: left; color: red; font-weight: bold; display: inline-block; z-index: 99;'></span>		
...
//		}
	...
	function onLocationFound(e) {
		...
		theSpeed = ((e.speed) && (e.speed != null)) ? e.speed : 0;		
		if(!theTrack) {
