...
function get_requests() {
	...
	function requests_cb(req) {
		...
		reqtabindex ++;
		the_string += "<TH class='plain_listheader text' roll='button' aria-label='Request ID' tabindex=" + reqtabindex + " style='width: 40px; border-right: 1px solid #FFFFFF;'>Danger</TH>";
		reqtabindex ++;
			...
			if(isNumeric(key)) {
				if(the_requests[key][0] == "No Current Requests") {
					...
					if((the_requests[key][16] == 'Open') || (the_requests[key][16] == 'Tentative')) {
						the_onclick = "onClick=\"window.open('./portal/request.php?id=" + the_request_id + "','view_request','width=600,height=600,titlebar=1, location=0, resizable=1, scrollbars=yes, status=0,toolbar=0,menubar=0,location=0, right=100,top=300,screenX=500,screenY=300')\"";
						} else {
						the_onclick = "";
						}
					...
					if(isUrgent) {
						the_string += "<TR title='" + theTitle + "' style='background-color: red; border-bottom: 2px solid #000000; height: 12px; width: 100%;'>";
						} else {
						the_string += "<TR title='" + theTitle + "' style='" + the_requests[key][17] + "; border-bottom: 2px solid #000000; height: 12px; width: 100%;'>";
						}
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(8, the_requests[key][0], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, urgentText, "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, the_requests[key][2], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(12, the_requests[key][3], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(12, the_requests[key][4], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='width: 15%; white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, theField, "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, the_requests[key][16], "\u00a0") + "</TD>";	
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(20, the_requests[key][18], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, the_requests[key][25], "\u00a0") + "</TD>";
					the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;' " + the_onclick + ">" + pad(15, the_requests[key][26], "\u00a0") + "</TD>";
					if(the_requests[key][35] != 0) {
						...
						the_string += "<TD CLASS='plain_list text' style='white-space: normal; word-wrap: break-word; -ms-word-wrap : sWrap; border-right: 1px solid #707070;'>" + pad(8, '', "\u00a0") + "</TD>";
						}
					the_string += "</TR>";
					reqtabindex ++;
					}
...
function requests_get() {
	if(reqs_interval != null) {return;}
	reqs_interval = window.setInterval('get_requests()', 30000);
	}	
	
function summary_get() {
	if(summary_interval != null) {return;}
	summary_interval = window.setInterval('get_summary()', 10000);
	}
