...
$is_warehouse = ($row['is_warehouse'] == 0) ? "No" : "Yes";
?>
</HEAD>
<BODY onLoad="get_stock(<?php print $id;?>);">
	...
	<DIV id = "leftcol" style='position: relative; left: 10px; float: left;'>
		...
		<TABLE BORDER=0 ID='viewForm'>
			...
			<TR CLASS = "even">
				...
				<TD CLASS="td_data text"><?php print $is_warehouse;?></TD>
			</TR>
			<TR class='spacer'>
				<TD class='spacer' COLSPAN=99></TD>
			</TR>
			<TR CLASS = "even">
				...
				<TD CLASS="td_data_wrap text"><?php print $row['name'];?></TD>
			</TR>
			<TR CLASS = 'odd'>
				<TD CLASS="td_label text"><?php print get_text("Location"); ?>: </TD>
				<TD CLASS="td_data_wrap text"><?php print $row['street'] ;?></TD>
			</TR>
			<TR CLASS = 'even'>
			...
			<TR CLASS = "even">
				...
				<TD CLASS="td_data_wrap text"><?php print $fa_names;?></TD>
			</TR>
			<TR class='spacer'>
				<TD class='spacer' COLSPAN=99></TD>
			</TR>			
			...
			<TR CLASS = "odd">
				...
				<TD CLASS="td_data_wrap text"><?php print $row['status_about'] ;?></TD>
			</TR>
			<TR class='spacer'>
				<TD class='spacer' COLSPAN=99></TD>
			</TR>
...
?>
				<TR CLASS='odd text_valign_top'>
					<TD CLASS="td_label text_valign_top">
						<A CLASS="td_label text" HREF="#" TITLE="Facility Stock List "><?php print get_text("Stock List"); ?>:</A>&nbsp;
					</TD>
					<TD CLASS="td_data text text_valign_top">
...
?>
			...
			<TR CLASS = "odd">
				...
				<TD CLASS="td_data_wrap text"><?php print $row['capab'];?></TD>
			</TR>
			<TR CLASS = "even">
...
?>
			...
			<TR CLASS = "odd">
				...
				<TD CLASS="td_data_wrap text"><?php print $row['access_rules'] ;?></TD>
			</TR>
			<TR CLASS = "even">
				<TD CLASS="td_label text"><?php print get_text("Security reqs"); ?>:</TD>	
				<TD CLASS="td_data_wrap text"><?php print $row['security_reqs'] ;?></TD>
			</TR>
			<TR CLASS = "odd">
				<TD CLASS="td_label text"><?php print get_text("Primary pager"); ?>:</TD>	
				<TD CLASS="td_data_wrap text"><?php print $row['pager_p'] ;?></TD>
			</TR>
			<TR CLASS = "even">
				<TD CLASS="td_label text"><?php print get_text("Secondary pager"); ?>:</TD>	
				<TD CLASS="td_data_wrap text"><?php print $row['pager_s'] ;?></TD>
			</TR>
			<TR CLASS = "odd">
			...
			<TR CLASS = "even">
				...
				<TD CLASS="td_data_wrap text"><?php print $row['notify_email'];?></TD>
			</TR>
			<TR CLASS = "odd">
