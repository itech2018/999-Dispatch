...
<?php
		...
		$load_str = ($row['is_warehouse'] == 0) ? "get_stock(" . $id . "); do_is_warehouse(0);" : "get_stock(" . $id . "); do_is_warehouse(1);";
?>
</HEAD>
<BODY onLoad="<?php print $load_str;?>">
...
<?php
							$sel_yes = ($row['is_warehouse'] == 1) ? "SELECTED" : "";
							$sel_no = ($row['is_warehouse'] == 0) ? "SELECTED" : "";						
							print "\t<OPTION VALUE=0 {$sel_no}>No</OPTION>\n";
							print "\t<OPTION VALUE=1 {$sel_yes}>Yes</OPTION>\n";
?>
						</SELECT>					
					</TD>
				</TR>
...
?>
				...
				<TR id='warehouse_information' CLASS='odd text_valign_top'>
					<TD CLASS="td_label text_valign_top">
						<LABEL for="beds_a" style='width: 100%;' title="Facility beds "><?php print get_text("Stock List");?>:</LABEL>
					</TD>
					<TD>&nbsp;</TD>
					<TD COLSPAN='2' CLASS="td_data text text_valign_top">
