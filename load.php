...
<BODY>
	<DIV id='outer' class='even' style='height: 90%; padding: 10px;'>
		...
		<DIV id='main' style='position: relative; top: 40px;'>
			<SPAN class='header' style='display: block; font-size: 1.2em;'>Direct Messages</SPAN>
			<DIV style="height: 110px; overflow-y: scroll;"><?php echo show_direc(20);?></DIV><BR />
			<SPAN class='header' style='display: block; font-size: 1.2em;'>Timeline</SPAN>
			<DIV><?php echo show_tweets();?></DIV><BR />
		</DIV>
	</DIV>
</BODY>
